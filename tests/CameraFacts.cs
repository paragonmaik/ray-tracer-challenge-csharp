...
public class CameraFacts
{
  public class Cameras
  {
    ...
    )
    {
      ...
      Assert.True(Math.Abs(0.01f - cam.PixelSize) < 0.01);
    }
    ...
    public void ValidateDefaultMatrixOrientation()
    {
      ...
      Point to = new(0, 0, -1);
      Vector up = new(0, 1, 0);
      Matrix expectedViewTransform = new Matrix(4).Identity();

      Matrix actualViewTransform = cam.ViewTransform(
        from,
        to,
        up
      );
    ...
    public void ValidateViewTransformZDirection()
    {
      ...
      Point to = new(0, 0, 1);
      Vector up = new(0, 1, 0);
      Matrix expectedViewTransform = new Matrix(4).Scale(
        -1,
        -1,
        -1
      );
    ...
    public void ValidateViewTransformsMoveScene()
    {
      ...
      Matrix expectedViewTransform = new Matrix(4).Translate(
        0,
        0,
        -8
      );
